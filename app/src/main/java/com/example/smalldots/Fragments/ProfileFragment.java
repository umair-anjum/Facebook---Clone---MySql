package com.example.smalldots.Fragments;
...
import com.example.smalldots.adapter.PostAdapter;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        Toast.makeText(context, "here its is"+uid, Toast.LENGTH_SHORT).show();
        ...
        newsfeed.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
               ...
               // Toast.makeText(context, "here its is", Toast.LENGTH_SHORT).show();
